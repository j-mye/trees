...
# Save GeoJSON
output_path = '../../data/quarter_sections_map.geojson'
...
summary_path = '../../data/map_summary.json'
...
tree_sample = inventory_df.sample(n=min(10000, len(inventory_df)), random_state=42)
tree_points = []
...
tree_points_path = '../../data/tree_points_sample.json'
